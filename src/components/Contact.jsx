  ...
  const handleSubmit = (e) => {
    ...
    emailjs
      .send(
        ...
        {
          from_name: form.name,
          to_name: "Dhruv Tripathi",
          from_email: form.email,
          to_email: "dhruv.tripathi@example.com",
      ...
      .then(
        ...
        (error) => {
          ...
          alert("Sorry, something went wrong. Please try again or contact me directly at dhruv.tripathi@example.com");
        }
      );
  };
