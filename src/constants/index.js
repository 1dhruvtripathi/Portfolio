...
const experiences = [
  {
    ...
    points: [
      "Designed and developed a Virtual Laboratory using Blender and Unity, delivering interactive 3D simulations that improved student engagement by 25%+.",
      "Conducted technical workshops for 150+ students, strengthening practical learning and bridging the gap between theoretical knowledge and real-world applications.",
      "Prepared detailed technical documentation, streamlining onboarding and reducing integration time for new team members by 20%."
    ],
  },
  {
    ...
    points: [
      "Guided an 11-member IEEE Student Branch team, driving technical initiatives, research collaborations, and community engagement.",
      "Organized and delivered 10+ workshops on Data Structures & Algorithms, DevOps, Cloud Computing, and Machine Learning; mentored 20+ students in technical skill-building.",
      "Coordinated an international conference with the University of Louisville (USA), enabling academic exchange between students and global experts.",
      "Engaged with international researchers on AI, ML, cloud computing, and cybersecurity, contributing to discussions on emerging technologies."
    ],
  },
];
...
const testimonials = [
  {
    testimonial: "Dhruv is a passionate developer who brings clarity and innovation to every project.",
    name: "Peer Reviewer",
  ...
  {
    testimonial: "Dhruv's work in ML and cloud automation is top-notch. Highly recommended!",
...
const projects = [
  {
    ...
    website_link: "https://portfolio-puce-kappa-34.vercel.app/",
    source_code_link: "https://github.com/1dhruvtripathi/Psit-Virtual-Labs.git/",
  },
  {
    ...
    source_code_link: "https://github.com/1dhruvtripathi/Motion-Detection-Camera.git",
  },
  {
    name: "DeepDR",
    ...
    source_code_link: "https://github.com/1dhruvtripathi/Diabetic-Retinopathy.git", // TODO: replace with actual repo link
  },
  {
    ...
    source_code_link: "https://github.com/1dhruvtripathi/Diabetic-Retinopathy-Using-Quantum-Transfer-Learning.git", // TODO: replace with actual repo link
  },
  {
    name: "Arogyaverse",
    ...
    website_link: "https://arogyaverse-rose.vercel.app/",
    source_code_link: "https://github.com/1dhruvtripathi/Arogyaverse.git", // TODO: replace with actual repo link
  },
  {
    ...
    source_code_link: "https://github.com/1dhruvtripathi/Virtual-Reality-Labs.git", // TODO: replace with actual repo link
  },
];
